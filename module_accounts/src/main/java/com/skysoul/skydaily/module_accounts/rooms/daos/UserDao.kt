...
import com.skysoul.skydaily.module_accounts.rooms.entities.DMWrongUser

@Dao
interface UserDao : BaseDao<DMUser> {
    @Query("SELECT * from user where id=:userId")
    suspend fun getUserById(userId: Long): DMUser?
...
//    fun getSimpleUserById(userId: Int):SimpleUser
    ...
    suspend fun getUserNameList(): List<DMUserNames>?
